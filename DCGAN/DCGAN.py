...
def show_result(num_epoch, show = False, save = False, path = 'result.png'):
    ...
    noise = torch.randn((5*5, 100)).view(-1, 100, 1, 1)
...
if not os.path.isdir('MNIST_DCGAN_results/Samples'):
    os.mkdir('MNIST_DCGAN_results/Samples')
...
for epoch in range(train_epoch):
    ...
    p = 'MNIST_DCGAN_results/Samples/MNIST_DCGAN_' + str(epoch + 1) + '.png'
...
for e in range(train_epoch):
    img_name = 'MNIST_DCGAN_results/Samples/MNIST_DCGAN_' + str(e + 1) + '.png'
